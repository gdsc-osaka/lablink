    ...
    <main className="min-h-screen bg-white">
      <div className="w-full mx-auto">
        ...
        <div className="w-full h-25 bg-gray-300">
          <h1 className="text-4xl font-bold text-black py-8 ml-10">イベントを編集</h1>
        </div>
        
        {/* 説明文 */}
        <div className="px-15 mt-6">
          <p className="text-gray-600">編集する項目を選択して、編集してください</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-15 mt-9">
          ...
          <div>
            <label htmlFor="timezone" className="block text-sm font-medium text-black mb-1">
              時間帯
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="details" className="block text-sm font-medium text-black mb-1">
              詳細
            </label>
            <input
              type="text"
