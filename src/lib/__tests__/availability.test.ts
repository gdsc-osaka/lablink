...
describe("Calendar Availability Functions", () => {
  describe("findCommonFreeSlots", () => {
    ...
    it("重複しないbusyIntervalsの場合、適切なfree slotsを返す", () => {
      ...
      // 12:00-14:00
      expect(result[1].start.toISOString()).toBe("2024-01-01T12:00:00.000Z");
      expect(result[1].end.toISOString()).toBe("2024-01-01T14:00:00.000Z");
      // 16:00-17:00
      expect(result[2].start.toISOString()).toBe("2024-01-01T16:00:00.000Z");
      expect(result[2].end.toISOString()).toBe("2024-01-01T17:00:00.000Z");
    });
