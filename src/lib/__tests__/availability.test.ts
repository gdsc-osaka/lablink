...
describe('findCommonFreeSlots', () => {
    ...
    it('should find free slots around single busy interval', () => {
        const busyIntervals = [
            { start: '2025-01-01T03:00:00.000Z', end: '2025-01-01T05:00:00.000Z' }
        ];
    ...
    it('should merge overlapping busy intervals', () => {
        const busyIntervals = [
            { start: '2025-01-01T02:00:00.000Z', end: '2025-01-01T04:00:00.000Z' },
            { start: '2025-01-01T03:00:00.000Z', end: '2025-01-01T05:00:00.000Z' },
            { start: '2025-01-01T04:30:00.000Z', end: '2025-01-01T06:00:00.000Z' }
        ];
    ...
    it('should handle busy intervals at boundaries', () => {
        const busyIntervals = [
            ...
            { start: '2025-01-01T08:00:00.000Z', end: '2025-01-01T10:00:00.000Z' }
        ];
    ...
    it('should filter out busy intervals outside search range', () => {
        const busyIntervals = [
            { start: '2024-12-31T20:00:00.000Z', end: '2024-12-31T23:00:00.000Z' }, // Before range
            { start: '2025-01-01T03:00:00.000Z', end: '2025-01-01T05:00:00.000Z' }, // Within range
            { start: '2025-01-01T12:00:00.000Z', end: '2025-01-01T15:00:00.000Z' }  // After range
        ];
    ...
    it('should handle adjacent busy intervals', () => {
        const busyIntervals = [
            { start: '2025-01-01T02:00:00.000Z', end: '2025-01-01T04:00:00.000Z' },
            { start: '2025-01-01T04:00:00.000Z', end: '2025-01-01T06:00:00.000Z' }
        ];
    ...
    it('should return empty array when entire period is busy', () => {
        const busyIntervals = [
            { start: '2025-01-01T00:00:00.000Z', end: '2025-01-01T10:00:00.000Z' }
        ];
    ...
    it('should handle unsorted busy intervals', () => {
        const busyIntervals = [
            { start: '2025-01-01T06:00:00.000Z', end: '2025-01-01T08:00:00.000Z' },
            { start: '2025-01-01T02:00:00.000Z', end: '2025-01-01T04:00:00.000Z' }
        ];
    ...
    it('should handle busy intervals partially overlapping search range', () => {
        const busyIntervals = [
            { start: '2024-12-31T23:00:00.000Z', end: '2025-01-01T02:00:00.000Z' }, // Starts before, ends within
            { start: '2025-01-01T08:00:00.000Z', end: '2025-01-01T12:00:00.000Z' }  // Starts within, ends after
        ];
