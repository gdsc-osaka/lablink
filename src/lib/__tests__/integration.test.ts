...
describe('Integration Tests', () => {
  ...
  it('複雑な予定パターンでも正しく空き時間を計算できる', () => {
    ...
    expect(freeSlots[0].start.toISOString()).toBe('2024-01-01T08:00:00.000Z');
    
    // 最後の空き時間が検索終了時刻で終わることを確認
    expect(freeSlots[freeSlots.length - 1].end.toISOString()).toBe('2024-01-01T17:00:00.000Z');
  });
  ...
  it('境界値の処理が正しく動作する', () => {
    ...
    expect(freeSlots[0].start.toISOString()).toBe('2024-01-01T09:00:00.000Z');
